...
class TestTodoApi:
    ...
    def test_create_task_detail_with_no_data_400_status_code(self, api_client, common_user):
        url = reverse('task:api-v1:task-list')
        data = {}
        user = common_user
        api_client.force_authenticate(user=user)
    ...
    def test_update_task_forbidden_403_status_code(self, api_client, common_task, another_user):
    ...
    def test_update_task_detail_200_status_code(self, api_client,common_user, common_task):
        task = common_task
        url = reverse('task:api-v1:task-detail', kwargs={'pk': task.id})
        data = {
            "title": "set up project",
    ...
    def test_partial_update_detail_401_status_code(self, api_client, common_task, field):
        task = common_task
        url = reverse('task:api-v1:task-detail', kwargs={'pk': task.id})
        data = {
            "title": "set up project",
    ...
    def test_partial_update_detail_200_status_code(self, api_client, common_task,common_user, field):
        task = common_task
        url = reverse('task:api-v1:task-detail', kwargs={'pk': task.id})
        data = {
            "title": "set up project",
    ...
    def test_delete_task_detail_403_status_code(self, api_client, common_task, another_user):
        task = common_task
        url = reverse('task:api-v1:task-detail', kwargs={'pk': task.id})
    ...
    def test_delete_task_detail_204_status_code(self, api_client, common_task, common_user):
        task = common_task
        url = reverse('task:api-v1:task-detail', kwargs={'pk': task.id})
        user = common_user 
        api_client.force_authenticate(user=user)
